...
* An up to date version of <a href="https://github.com/NemosNautilus/Nautilus/releases" target="_blank" rel="noopener noreferrer">[Nautilus]</a><sup>a <Icon name="linux" label="Linux" /> b</sup> (Previously known as C3 CON Tools/C3Tools).
...
<br></br>
<Aside><sup>a<Icon name="linux" label="Linux" /></sup>: This program is designed for Windows but can run on Linux via WINE or Proton. Check your Linux distro documentation for more information.  
	<sup>b</sup>: Windows often flags this as malware. This is a false positive.</Aside>


### Acknowledgements
This guide was originally started by <a href="https://github.com/SonicSBL" target="_blank" rel="noopener noreferrer">[SonicSBL]</a> then continued by <a href="https://www.youtube.com/@LinosMelendi" target="_blank" rel="noopener noreferrer">[Linos]</a> before being moved here.