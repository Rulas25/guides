...
* You will need to additionally map <a href="../../main#gamepads" target="_blank" rel="noopener noreferrer">[a dedicated gamepad for navigation]</a>. You can use a typing keyboard or a gamepad.
	...
	**To sign in, you have to close the Hi-Hat Pedal three times then hit the Snare within 2 seconds.**
...
## Combos
If you don't have <a href="../../main#gamepads" target="_blank" rel="noopener noreferrer">[a dedicated gamepad for navigation]</a>, you can still control _most_ of the game using drum combos.  
Do these combos within two seconds to access the following menus:
